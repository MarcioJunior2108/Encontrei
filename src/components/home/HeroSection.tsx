    ...
    >
      ...
      <div className="absolute inset-0 w-full h-full z-0 pointer-events-none">
        <Image 
          ...
          priority
        />
        <div className="absolute inset-0 bg-[hsl(var(--background))]/80 backdrop-blur-[6px]"></div>
      </div>

      {/* Background grid pattern */}
      <div
        className="absolute inset-0 opacity-[0.025] dark:opacity-[0.04] z-0 pointer-events-none"
        style={{
